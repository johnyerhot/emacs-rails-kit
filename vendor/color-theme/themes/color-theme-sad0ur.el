(defun color-theme-sad0ur ()
  ...
  (color-theme-install
   '(color-theme-sad0ur
     ...
     (font-lock-comment-face ((t (:italic t :foreground "SteelBlue" :slant oblique))))
     (font-lock-constant-face ((t (:foreground "firebrick3"))))
     ...
     (font-lock-function-name-face ((t (:foreground "Gray99" :height 0.9 :family "Verdana"))))
     (font-lock-keyword-face ((t (:foreground "YellowGreen"))))
     (font-lock-preprocessor-face ((t (:foreground "purple1"))))
     (font-lock-reference-face ((t (:foreground "SteelBlue"))))
     (font-lock-string-face ((t (:italic t :foreground "firebrick3" :slant oblique))))
     (font-lock-type-face ((t (:foreground "LimeGreen" :height 0.9 :family "Verdana"))))
