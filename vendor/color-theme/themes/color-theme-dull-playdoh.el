(defun color-theme-dull-playdoh ()
  "Attempt at a modern theme."
  (interactive)
  (color-theme-install
   '(color-theme-dull-playdoh
     ...
     (erb-exec-delim-face ((t (:bold t :foreground "#f3f3f3"))))
     (erb-out-delim-face ((t (:bold t :foreground "#f3f3f3"))))
     ...
     (font-lock-builtin-face ((t (:bold t :foreground "#C55B4B" :weight bold))))
     (font-lock-comment-face ((t (:foreground "#777"))))
     (font-lock-constant-face ((t (:bold t :foreground "#C55B4B" :weight bold))))
     (font-lock-doc-face ((t (:italic t :slant italic :foreground "#6688ee"))))
     (font-lock-doc-string-face ((t (:foreground "#6688ee"))))
     (font-lock-function-name-face ((t (:foreground "#ffffbb"))))
     ...
     (font-lock-string-face ((t (:foreground "#95D4AD"))))
     (font-lock-type-face ((t (:bold t :foreground "#2F77A4" :weight bold))))
     (font-lock-variable-name-face ((t (:bold t :foreground "#f3f3f3" :weight bold))))
